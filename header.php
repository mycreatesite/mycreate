    ...
    <?php if (is_home() || is_front_page()):?>
      <?php
        ...
        if ($getHour > 16) {
          ...
          $greetChoice = $myGreet[1];
        } else if ($getHour > 4) {
          $greetChoice = $myGreet[0];
        } else {
          $greetChoice = $myGreet[2];
        }
        $myWords = [
        ...
        $wordChoice = $myWords[array_rand($myWords)];
      ?>
      <div id="loadingArea" class="loadingArea">
        <div class="loadingContents">
          <p class="loadingGreet animated fadeInDown"><?php echo $greetChoice ?></p>
          <p class="loadingText italic animated fadeInDown"><?php echo $wordChoice ?></p>
          <div class="spinner">
    ...
    <header class="header">
      <h1 class="logoHeader">
        <a href="<?php echo home_url();?>">
          <svg version="1.1" id="mycLogo" class="mycLogo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 634.471 316.48">
      ...
      <nav id="navHeader" class="navHeader">
        <ul>
          ...
          <li><a href="<?php if ( is_home() || is_front_page() ) : ?>#skills<?php else : ?><?php echo home_url('?id=skills');?><?php endif; ?>">skills</a></li>
          <li><a href="<?php if ( is_home() || is_front_page() ) : ?>#gallery<?php else : ?><?php echo home_url('?id=gallery');?><?php endif; ?>">gallery</a></li>
          <li><a href="<?php if ( is_home() || is_front_page() ) : ?>#blog<?php else : ?><?php echo home_url('?id=blog');?><?php endif; ?>">blog</a></li>
          <li><a href="<?php if ( is_home() || is_front_page() ) : ?>#contact<?php else : ?><?php echo home_url('?id=contact');?><?php endif; ?>">contact</a></li>
        </ul>
      </nav>
