    ...
    <section id="introduction" class="introduction contentsFrame">
      <div class="container">
        ...
        <p id="commentAnim">初めまして。東京・神奈川を拠点とするWEBデザイナー、ma-ya’s CREATE［まーやずくりえいと］といいます。WEBサービス運営企業にて勤務しつつ、自身のバンド活動におけるサイト運営やバナー作成、フライヤーなど印刷物の制作を重ねること早10年弱。ありがたいことにその中でデザインのご依頼をちょくちょく頂けるようになり、WEBから印刷系デザインまで、やれそうなことなら何でも挑戦させて貰っています。シンプルでスマートな中にほんのりとポップさを感じるデザインを基本に置きつつ、ご要望に応じてダイナミックな表現や異なるテイストを出せるように奮闘する、気づけば30代既婚のいいオッサンです。</p>
